...
public class CountryNameCodeHandler<T extends CountryNameCode> implements
    ...
    public void addChildsToNode(ElementNode<T> node) {
        ...
        if (scheme != null) {
            AttributeNode schemeNode = NodeFactory.createAttributeNode(SCHEME,
                    scheme, node);
            node.addChild(schemeNode);
        }
