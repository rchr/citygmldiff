...
public class PremiseNumberPrefixHandler<T extends PremiseNumberPrefix>
    ...
    public void addChildsToNode(ElementNode<T> node) {
        ...
        if (numberPrefixSeparator != null) {
            AttributeNode numberPrefixSepNode = NodeFactory.createAttributeNode(NUMBER_PREFIX_SEPARATOR, numberPrefixSeparator, node);
