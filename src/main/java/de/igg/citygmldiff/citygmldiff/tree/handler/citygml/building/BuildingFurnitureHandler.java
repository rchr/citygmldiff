 ...
 * Time: 17:27
 */
public class BuildingFurnitureHandler<T extends BuildingFurniture> extends AbstractCityObjectHandler<T> implements Constants {
    ...
    public void addChildsToNode(ElementNode<T> node) {
        ...
        List<ADEComponent> genericApplicationPropertyOfBuildingFurniture = element.getGenericApplicationPropertyOfBuildingFurniture();
    }
