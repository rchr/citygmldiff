...
public class MailStopNumberHandler<T extends MailStopNumber> implements
    ...
    public void addChildsToNode(ElementNode<T> node) {
        ...
        // attributes
        String nameNumberSeparator = element.getNameNumberSeparator();
        if (nameNumberSeparator != null) {
            AttributeNode typeNode = NodeFactory.createAttributeNode(
                    NAME_NUMBER_SEPARATOR, nameNumberSeparator, node);
